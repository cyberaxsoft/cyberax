...
typedef enum _TlvSystenTag
{
	...
	tst_DateTime					= 0x000C,
	tst_OperatorName				= 0x000D,
	tst_OperatorInn					= 0x000E,
	tst_PrintMode					= 0x000F,
	tst_FiscalReceipt				= 0x0010,
	tst_DocumentNumber				= 0x0011,
	tst_Comment						= 0x0012,
	tst_TextDocument				= 0x0013,
	tst_CorrectionType				= 0x0014,
	tst_CorrectionMode				= 0x0015,
	tst_CashType					= 0x0016,
	tst_Vat							= 0x0017,
	tst_DocumentId					= 0x0018,
	tst_DeviceReplyCodeDescount 	= 0x0019,
	tst_Guid						= 0x001A,
	tst_Name						= 0x001B,
	tst_DiscountType				= 0x001C,
	tst_DiscountDirectionType 		= 0x001D,
	tst_DiscountValue				= 0x001E,
	tst_Barcode						= 0x001F,
	tst_Unit						= 0x0020,
	tst_DiscountComment				= 0x0021,
...
typedef enum _TlvSystemScTag
{
	tsst_Id							= 0x0001,
	tsst_Name						= 0x0002,
	tsst_Port						= 0x0003,
	tsst_Enable						= 0x0004,
	tsst_CommandTimeout				= 0x0005,
	tsst_Interval					= 0x0006,
	tsst_Module						= 0x0007,
	tsst_LogDir						= 0x0008,
	tsst_LogEnable					= 0x0009,
	tsst_LogTrace					= 0x000A,
	tsst_LogFileSize				= 0x000B,
	tsst_LogSaveDays				= 0x000C,
	tsst_ModuleSettings				= 0x000D,
...
typedef enum _TlvSensorModuleConfigurtaionTag
{
	tsmct_Number					= 0x0001,
	tsmct_Addr						= 0x0002,
	tsmct_Param						= 0x0003,
}TlvSensorModuleConfigurtaionTag;


typedef enum _TlvSensorParamModuleConfigurtaionTag
{
	tspmct_Number					= 0x0001,
	tspmct_Type						= 0x0002,
}TlvSensorParamModuleConfigurtaionTag;
